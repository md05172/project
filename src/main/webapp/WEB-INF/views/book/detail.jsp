	...
	<div class="main_container">
		<div class="detail_container">
			...
			<div class="right_box">
				...
				<span class="writer">${item.writer }</span> <span class="publisher">${item.publisher }</span>
				<div class="heart">
				...
				<c:forEach var="relate" items="${relatedList }">
					<div class="relate">
						<div class="relate_img_box">
							<a href="../detail/${relate.id }"> <img alt=""
								src="/upload/book/${relate.path }">
							</a>
						</div>
						...
						<div class="relate_wr_pu">
							<span class="r_writer">${relate.writer }</span> <span
								class="r_publisher">${relate.publisher }</span>
						</div>
						<div class="relate_price">
							<p>${relate.price }원</p>
						</div>
						<div class="relate_review">
							<span class="relate_star"><img alt=""
								src="/resources/images/full_star.png"></span>
							<c:if test="${relate.avg > 0 }">
								<span class="r_review"><fmt:formatNumber
										value="${relate.avg }" pattern=".00" /></span>
							</c:if>
					...
					<div class="review_list">
						<!-- <div class="review_content">
								<div class="review_header">
									<div class="left_area">
										<span class="info_item">이름</span><span class="gap">|</span><span class="info_item">작성일</span>
									</div>
									
									<div class="right_area">
										<div class="review_star_box">
											<div class="review_rating" id="review_rating"></div>
										</div>
									</div>
